...
<<<<<<< HEAD
const UserController = { bulkDelete, index, create, store, edit, update, destroy }
=======
const UserController = { bulkDelete, updateInline, index, create, store, show, edit, update, destroy }
>>>>>>> origin/main
