...
* @see app/Http/Controllers/DistrictController.php:40
* @route '/districts'
*/
...
* @see app/Http/Controllers/DistrictController.php:13
* @route '/districts'
*/
...
* @see app/Http/Controllers/DistrictController.php:33
