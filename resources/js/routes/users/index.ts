 ...
 * @see app/Http/Controllers/UserController.php:111
...
/**
* @see \App\Http\Controllers\UserController::inlineUpdate
 * @see app/Http/Controllers/UserController.php:77
 * @route '/users/{user}/inline-update'
 */
export const inlineUpdate = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/users/{user}/inline-update'
 */
inlineUpdate.url = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
 ...
 * @route '/users/{user}/inline-update'
 */
inlineUpdate.patch = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: inlineUpdate.url(args, options),
    method: 'patch',
})
 ...
 * @route '/users/{user}/inline-update'
 */
    const inlineUpdateForm = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/users/{user}/inline-update'
 */
        inlineUpdateForm.patch = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: inlineUpdate.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
